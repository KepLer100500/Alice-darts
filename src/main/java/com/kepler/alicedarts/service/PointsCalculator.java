package com.kepler.alicedarts.service;

import com.kepler.alicedarts.model.exchange.request.Nlu;
...
public class PointsCalculator {
    public static HashMap<String, String> getPreviousCurrentNextValues(ListIterator<String> wordsIterator) {
        /*
    ...
    private static int bullOrHalfBull(String word) {
        /*
    ...
    private static int multipliedSector(String multiplier, int sector) {
        /*
    ...
    private static int multipliedBullOrHalfBull(int multiplier, String sector) {
        /*
    ...
    private static int getMultipliedValueIfExist(HashMap<String, String> values, int curNumber) {
        /*
    ...
    public static Integer calculate(Nlu nlu) {
        int result = 0;
        List<String> words = new ArrayList<>(List.of(nlu.getTokens()));
